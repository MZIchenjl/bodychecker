...
const chainableTypeChecker = (validate) => {
  const checkType = (isRequired, body, fieldpath) => {
    ...
    if (_.isUndefined(fieldvalue)) {
      if (isRequired) {
        return {
          err_msg: `Field path: \`${fieldpath}\` is required, but empty!`,
          err_type: 'empty',
          fieldpath: fieldpath,
...
const arrayChecker = () => {
  const validate = (body, fieldpath) => {
    ...
    return {
      err_msg: `Field path: \`${fieldpath}\`, value: ${JSON.stringify(fieldvalue)} is invalid, type "array" expected!`,
      err_type: 'invalid',
      fieldpath: fieldpath,
      fieldvalue: fieldvalue
    }
...
const boolChecker = () => {
  const validate = (body, fieldpath) => {
    ...
    return {
      err_msg: `Field path: \`${fieldpath}\`, value: ${JSON.stringify(fieldvalue)} is invalid, type "boolean" expected!`,
      err_type: 'invalid',
      fieldpath: fieldpath,
      fieldvalue: fieldvalue
    }
...
const numberChecker = () => {
  const validate = (body, fieldpath) => {
    ...
    return {
      err_msg: `Field path: \`${fieldpath}\`, value: ${JSON.stringify(fieldvalue)} is invalid, type "number" expected!`,
      err_type: 'invalid',
      fieldpath: fieldpath,
      fieldvalue: fieldvalue
    }
...
const objectChecker = () => {
  const validate = (body, fieldpath) => {
    ...
    return {
      err_msg: `Field path: \`${fieldpath}\`, value: ${JSON.stringify(fieldvalue)} is invalid, type "object" expected!`,
      err_type: 'invalid',
      fieldpath: fieldpath,
      fieldvalue: fieldvalue
    }
...
const stringChecker = () => {
  const validate = (body, fieldpath) => {
    ...
    return {
      err_msg: `Field path: \`${fieldpath}\`, value: ${JSON.stringify(fieldvalue)} is invalid, type "string" expected!`,
      err_type: 'invalid',
      fieldpath: fieldpath,
      fieldvalue: fieldvalue
    }
...
const oneOfChecker = (arr) => {
  ...
  const validate = (body, fieldpath) => {
    ...
    return {
      err_msg: `Field path: \`${fieldpath}\`, value: ${JSON.stringify(fieldvalue)} is invalid, can't find the value in the "oneof" array!`,
      err_type: 'invalid',
      fieldpath: fieldpath,
      fieldvalue: fieldvalue
    }
...
const oneOfTypeChecker = (arr) => {
  ...
  const validate = (body, fieldpath) => {
    ...
    return {
      err_msg: `Field path: \`${fieldpath}\`, value: ${JSON.stringify(fieldvalue)} is invalid, the value can't pass any checker in the "oneoftype" array!`,
      err_type: 'invalid',
      fieldpath: fieldpath,
      fieldvalue: fieldvalue
    }
